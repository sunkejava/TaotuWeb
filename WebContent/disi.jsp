...
SELECT CASE WHEN COUNT(*) MOD 15 > 0 THEN COUNT(*) DIV 15 +1 ELSE COUNT(*) DIV 15 END AS Pages FROM db_taotu WHERE name like "%XIUREN秀人网%" or tagName like "%XIUREN秀人网%";
</sql:query>
...
<div class="scroll_title">
			...
			</span> <span class="active"> <a href="disi.jsp">秀人网</a>
...
SELECT * FROM db_taotu where name like "%XIUREN秀人网%" or tagName like "%XIUREN秀人网%" ORDER BY ADDTIME DESC LIMIT  <%=startnum %>,15;
</sql:query>
<div class="container">		
    		<div id="images">
