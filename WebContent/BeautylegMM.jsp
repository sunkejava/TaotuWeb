...
SELECT CASE WHEN COUNT(*) MOD 15 > 0 THEN COUNT(*) DIV 15 +1  END AS Pages FROM db_taotu WHERE typeName = "BeautylegMM";
</sql:query>
...
SELECT * FROM db_taotu where typeName = "BeautylegMM" ORDER BY ADDTIME DESC LIMIT <%=startnum %>,15;
</sql:query>
<div class="container">		
    		<div id="images">
    			<c:forEach var="arow" items="${result1.rows}">
                <div class="items">
                	<a href="getdetail.jsp?u=<c:out value='${arow.id}'/>">
