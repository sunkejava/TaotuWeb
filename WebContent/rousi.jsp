...
SELECT CASE WHEN COUNT(*) MOD 15 > 0 THEN COUNT(*) DIV 15 +1 ELSE COUNT(*) DIV 15 END AS Pages FROM db_taotu WHERE name like "%Ugirls尤果网%" or tagName like "%Ugirls尤果网%";
</sql:query>
...
<div class="scroll_title">
			...
			</span> <span class="active"> <a href="rousi.jsp">尤果网</a>
			</span> <span> <a href="meitulu.jsp">美图录</a>
			</span>
		</div>

<sql:query dataSource="${snapshot}" var="result1">
SELECT * FROM db_taotu where name like "%Ugirls尤果网%" or tagName like "%Ugirls尤果网%" ORDER BY ADDTIME DESC LIMIT <%=startnum %>,15;
</sql:query>
<div class="container">		
    		<div id="images">
